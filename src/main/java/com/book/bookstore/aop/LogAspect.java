package com.book.bookstore.aop;

import com.book.bookstore.BookstoreApplication;
...
public class LogAspect {
    protected static final Logger logger = LoggerFactory.getLogger(BookstoreApplication.class);

    @Pointcut("execution(public * com.book.bookstore.controller.*.*(..))")
    public void webLog() {
    }
